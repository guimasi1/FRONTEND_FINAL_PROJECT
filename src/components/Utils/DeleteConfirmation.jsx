...
const DeleteConfirmation = ({
  ...
  return (
    <div
      className={`${
        theme === "dark" ? "bg-grey-2" : "greenish-6"
      } d-flex flex-column gap-2 mb-2 ms-3 shadow-lg fw-bold delete-confirmation-alert rounded py-2 px-4 align-items-center border border-3`}
    >
